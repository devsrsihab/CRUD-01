...
@section('content')
                ...
                <div class="panel-body">
                    <div class="panel-heading">
                        <h5 class="panel-title">Add Post Update</h5>
                    ...
                    <form class="form-horizontal" action="/update/{{ $posts->id }}" method="post">
                        ...
                        <fieldset class="content-group">
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input id="title" name="title" type="text" value="{{ $posts->title }}" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-lg-2" id="author" >Author</label>
                                <div class="col-lg-10">
                                    <input id="author" name="author" type="text" value="{{ $posts->author }}"  class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-lg-2 " for="descrption" >Description</label>
                                <div class="col-lg-10">
                                    <input id="descrption" name="descrption" type="text" value="{{ $posts->descrption }}"  class="form-control">
                                </div>
                            </div>
